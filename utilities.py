...
def distance_between_rects(rect1: Rectangle, rect2: Rectangle) -> float:
    center1 = center_of_rect(rect1)
    center2 = center_of_rect(rect2)
    return vector2_length(vector2_subtract(center1, center2))
